...
```{r run LDATS LDA and LDATS changepoint}
...
```{r run paper LDA and LDATS changepoint}
#### Run LDATS changepoint ####
...
halfinterval = 2 * as.integer((as.Date(rodents$document_covariate_table$censusdate[ which(rodents$document_covariate_table$newmoon == paper_ldats_cpt_dates$newmoon[3] + 1)]) - as.Date(rodents$document_covariate_table$censusdate[ which(rodents$document_covariate_table$newmoon == paper_ldats_cpt_dates$newmoon[3] - 2)]))/3)
