...
paper_filepath <- here::here("vignettes", "temp_files")
...
best_ntopic <- repeat_VEM(paper_dat,
                          ...
                          topic_min = 2,
                          topic_max = 6)
hist(best_ntopic$k, xlab = "best # of topics", main = "", 
...
png(file.path(paper_filepath, "lda_plot.png"), width = 1000, height = 600)
...
```{r}
knitr::include_graphics(file.path(paper_filepath, "lda_plot.png"))
