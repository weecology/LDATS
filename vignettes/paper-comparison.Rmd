...
```
```{r include = FALSE, eval = params$run_models}
saveRDS(paper_paper_cpt_plot, file = file.path(vignette_files,  "output", "paper_paper_cpt_plot.RDS"))
```

```{r eval = !params$run_models, include = FALSE}
paper_paper_cpt_plot <- readRDS(file.path(vignette_files, "output", "paper_paper_cpt_plot.RDS"))
```
...
```
```{r include = FALSE, eval = params$run_models}
saveRDS(ldats_paper_cpt_plot, file = file.path(vignette_files,  "output", "ldats_paper_cpt_plot.RDS"))
```

```{r eval = !params$run_models, include = FALSE}
ldats_paper_cpt_plot <- readRDS(file.path(vignette_files, "output", "ldats_paper_cpt_plot.RDS"))
```
