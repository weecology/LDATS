...
test_file <- file.path(vignette_files, "model_outputs", "ldats_ldamodel.RDS")

if (!file.exists(test_file)){

  dir.create(file.path(vignette_files, "model_outputs"), showWarnings = FALSE)
  ...
  for (file in files_to_download){
    download.file(url = paste0(github_path, file),
                  destfile = file.path(vignette_files, "model_outputs", file), 
                  mode = "wb")
  }
}
```
...
saveRDS(ldats_rodents_adjusted, file = file.path(vignette_files, "model_outputs", "ldats_rodents_adjusted.RDS"))
```

Now we can compare the adjusted LDATS dataset with both the original ldats dataset and the dataset from the paper:

```{r eval = !params$run_models, include = FALSE}
ldats_rodents_adjusted <- readRDS(file.path(vignette_files, "model_outputs", "ldats_rodents_adjusted.RDS"))
```
...
```
```{r eval = params$run_models, include = FALSE}
saveRDS(rodents, file = file.path(vignette_files, "model_outputs", "rodents.RDS"))
```
...
png(file.path(vignette_files, "model_outputs", "lda_distances.png"), width = 800, height = 400)
...
```{r}
knitr::include_graphics(file.path(vignette_files, "model_outputs", "lda_distances.png"))
```
...
```{r}
ldamodel <- readRDS(file.path(vignette_files, "model_outputs", "paper_ldamodel.RDS"))
ldats_ldamodel <- readRDS(file.path(vignette_files, "model_outputs", "ldats_ldamodel.RDS"))
```
...
saveRDS(annual_hist, file = file.path(vignette_files, "model_outputs", "annual_hist.RDS"))
```
...
saveRDS(ldats_paper_results, file = file.path(vignette_files, "model_outputs", "ldats_paper.RDS"))
```

Extract the dates of the changepoints:
```{r compute changepoints for LDATS LDA and paper cpt, eval = params$run_models}
ldats_paper_results <- readRDS(file.path(vignette_files, "model_outputs", "ldats_paper.RDS"))
...
saveRDS(ldats_paper_cpt, file = file.path(vignette_files, "model_outputs", "ldats_paper_cpt.RDS"))
saveRDS(ldats_paper_cpt_dates, file = file.path(vignette_files, "model_outputs", "ldats_paper_cpt_dates.RDS"))
```
...
paper_paper_results <- readRDS(file.path(vignette_files, "model_outputs", "paper_paper.RDS"))
...
```
```{r include = FALSE, eval = !params$run_models}
saveRDS(paper_paper_cpt, file = file.path(vignette_files, "model_outputs", "paper_paper_cpt.RDS"))
saveRDS(paper_paper_cpt_dates, file = file.path(vignette_files, "model_outputs", "paper_paper_cpt_dates.RDS"))
```
...
saveRDS(ldats_ldats_results, file = file.path(vignette_files, "model_outputs", "ldats_ldats.RDS"))
```
...
ldats_ldats_results <- readRDS(file.path(vignette_files, "model_outputs", "ldats_ldats.RDS"))
...
```
```{r include = FALSE, eval = !params$run_models}
saveRDS(ldats_ldats_cpt, file = file.path(vignette_files,  "model_outputs", "ldats_ldats_cpt.RDS"))
saveRDS(ldats_ldats_cpt_dates, file = file.path(vignette_files,  "model_outputs", "ldats_ldats_cpt_dates.RDS"))
```
...
saveRDS(paper_ldats_results, file = file.path(vignette_files, "model_outputs", "paper_ldats.RDS"))
```

Select the best time series model and extract the dates of the changepoints:

```{r select paper lda + ldats cpt, eval = params$run_models}
paper_ldats_results <- readRDS(file.path(vignette_files, "model_outputs", "paper_ldats.RDS"))
...
```
```{r include = FALSE, eval = !params$run_models}
saveRDS(paper_ldats_cpt, file = file.path(vignette_files,  "model_outputs", "paper_ldats_cpt.RDS"))
saveRDS(paper_ldats_cpt_dates, file = file.path(vignette_files,  "model_outputs", "paper_ldats_cpt_dates.RDS"))
```

## How many changepoints were identified?
```{r eval = !params$run_models, include = FALSE}
ldats_paper_cpt <- readRDS(file.path(vignette_files, "model_outputs", "ldats_paper_cpt.RDS"))
paper_paper_cpt <- readRDS(file.path(vignette_files, "model_outputs", "paper_paper_cpt.RDS"))
paper_ldats_cpt <- readRDS(file.path(vignette_files, "model_outputs", "paper_ldats_cpt.RDS"))
ldats_ldats_cpt <- readRDS(file.path(vignette_files, "model_outputs", "ldats_ldats_cpt.RDS"))
ldats_paper_cpt_dates <- readRDS(file.path(vignette_files, "model_outputs", "ldats_paper_cpt_dates.RDS"))
paper_paper_cpt_dates <- readRDS(file.path(vignette_files, "model_outputs", "paper_paper_cpt_dates.RDS"))
paper_ldats_cpt_dates <- readRDS(file.path(vignette_files, "model_outputs", "paper_ldats_cpt_dates.RDS"))
ldats_ldats_cpt_dates <- readRDS(file.path(vignette_files, "model_outputs", "ldats_ldats_cpt_dates.RDS"))
```
```{r}
...
paper_paper_cpt_plot <- get_ll_non_memoized_plot(ldamodel, paper_covariates, paper_cpts, make_plot = TRUE,
                                           weights = rep(1, NROW(paper_covariates)))

```
```{r include = FALSE, eval = params$run_models}
saveRDS(paper_paper_cpt_plot, file = file.path(vignette_files,  "model_outputs", "paper_paper_cpt_plot.RDS"))
```

```{r eval = !params$run_models, include = FALSE}
paper_paper_cpt_plot <- readRDS(file.path(vignette_files, "model_outputs", "paper_paper_cpt_plot.RDS"))
}
...
ldats_paper_cpt_plot <- get_ll_non_memoized_plot(ldats_ldamodel, paper_covariates, ldats_cpts, make_plot = TRUE,
                                           weights = rep(1, NROW(paper_covariates)))

```
```{r include = FALSE, eval = params$run_models}
saveRDS(ldats_paper_cpt_plot, file = file.path(vignette_files,  "model_outputs", "ldats_paper_cpt_plot.RDS"))
```

```{r eval = !params$run_models, include = FALSE}
ldats_paper_cpt_plot <- readRDS(file.path(vignette_files, "model_outputs", "ldats_paper_cpt_plot.RDS"))
}
...
saveRDS(cpt_dates, file = file.path(vignette_files,  "model_outputs", "cpt_dates.RDS"))
```

```{r eval = !params$run_models, include = FALSE}
cpt_dates <- readRDS(file.path(vignette_files, "model_outputs", "cpt_dates.RDS"))
}
