...
```{r eval = params$run_models, include = FALSE}
saveRDS(find_changepoints, file = file.path(vignette_files, "model_outputs", "find_changepoints.RDS"))
saveRDS(select_cpt_model, file = file.path(vignette_files, "model_outputs", "select_cpt_model.RDS"))
saveRDS(get_dates, file = file.path(vignette_files, "model_outputs", "get_dates.RDS"))
```
