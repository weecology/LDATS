...
png(file.path(paper_filepath, "lda_plot.png"), width = 800, height = 400)
...
saveRDS(paper_paper_results, file = file.path(paper_filepath, "paper_paper.RDS"))
```
...
```{r run LDATS LDA and LDATS changepoint, eval = TRUE}
