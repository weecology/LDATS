...
```{r load paper data, include = F}
load(here::here('vignettes', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'paper_data.Rds'))
```
...
```{r load trap_table, include = F}
load(here::here('vignettes', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'trap_table.Rds'))
```
...
df_4 = as.data.frame(t(ldats_paper_cp_results_rodent4$saved[,1,])) %>% reshape::melt()
year_continuous = 1970 + as.integer(julian(paper_dates)) / 365.25
...
rm(list = c('ldats_paper_cp_results_rodent', 'ldats_paper_cp_results_rodent2', 'ldats_paper_cp_results_rodent3', 'ldats_paper_cp_results_rodent4', 'ldats_paper_cp_results_rodent5', 'ldats_paper_cp_results_rodent6', 'ntopics', 'ldats_lda_selected', 'df_4'))
```
...
df_4 = as.data.frame(t(paper_paper_cp_results_rodent4$saved[,1,])) %>%  reshape::melt()
df_4$value = year_continuous[df_4$value]
...
rm(list = c('paper_paper_cp_results_rodent', 'paper_paper_cp_results_rodent2', 'paper_paper_cp_results_rodent3', 'paper_paper_cp_results_rodent4', 'paper_paper_cp_results_rodent5', 'paper_paper_cp_results_rodent6', 'ntopics', 'ldamodel', 'df_4'))
```
