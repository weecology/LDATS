...
# assemble `paper_dates`, the associated dates for `paper_dat`
...
#### Changepoint model selection ####
load(here::here('vignettes', 'christensenetal-comparison-files', 'model-cache', 'paper_paper.Rds'))
```
...
ldats_dates <- dplyr::select(moondat, 
                             index = newmoonnumber, 
                             date = newmoondate) %>%
