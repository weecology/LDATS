...
paper_filepath <- here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files')
test_filepath <- here::here('vignette', 'christensenetal-ristensenetal-comparison-files', 'christensenetal-2018-files', 'rodent_LDA_analysis.r')
...
```{r Paper data}
source(here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'rodent_data_for_LDA.r'))
...
save(ldats_ldas, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_ldas.Rds'))
save(ldats_lda_selected, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_lda_selected.Rds'))
...
```{r paper LDAs, eval = F}
source(here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'AIC_model_selection.R'))
source(here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'LDA-distance.R'))
...
save(ldamodel,file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_ldamodel.Rds'))
```
...
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_lda_selected.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_ldamodel.Rds'))
...
#### Run changepoint ####
source(here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'changepointmodel.r'))
...
save(cp_results_rodent, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_1.Rds'))
rm(cp_results_rodent)

cp_results_rodent2 = changepoint_model(ldats_lda_selected[[1]], x, 2, weights = rep(1,length(year_continuous)))
save(cp_results_rodent2, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_2.Rds'))
rm(cp_results_rodent2)

cp_results_rodent3 = changepoint_model(ldats_lda_selected[[1]], x, 3, weights = rep(1,length(year_continuous)))
save(cp_results_rodent3, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_3.Rds'))
rm(cp_results_rodent3)

cp_results_rodent4 = changepoint_model(ldats_lda_selected[[1]], x, 4, weights = rep(1,length(year_continuous)))
save(cp_results_rodent4, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_4.Rds'))
rm(cp_results_rodent4)

cp_results_rodent5 = changepoint_model(ldats_lda_selected[[1]], x, 5, weights = rep(1,length(year_continuous)))
save(cp_results_rodent5, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_5.Rds'))
rm(cp_results_rodent5)

cp_results_rodent6 = changepoint_model(ldats_lda_selected[[1]], x, 6, weights = rep(1,length(year_continuous)))
save(cp_results_rodent6, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_6.Rds'))
rm(cp_results_rodent6)
```

```{r select LDATS LDA and paper cpt}
#### Changepoint model selection ####
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_1.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_2.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_3.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_4.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_5.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_paper_6.Rds'))
...
save(cp_results_rodent, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper1.Rds'))
rm(cp_results_rodent)

cp_results_rodent2 = changepoint_model(ldamodel, x, 2, weights = rep(1,length(year_continuous)))
save(cp_results_rodent2, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper2.Rds'))
rm(cp_results_rodent2)

cp_results_rodent3 = changepoint_model(ldamodel, x, 3, weights = rep(1,length(year_continuous)))
save(cp_results_rodent3, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper3.Rds'))
rm(cp_results_rodent3)

cp_results_rodent4 = changepoint_model(ldamodel, x, 4, weights = rep(1,length(year_continuous)))
save(cp_results_rodent4, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper4.Rds'))
rm(cp_results_rodent4)

cp_results_rodent5 = changepoint_model(ldamodel, x, 5, weights = rep(1,length(year_continuous)))
save(cp_results_rodent5, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper5.Rds'))
rm(cp_results_rodent5)

cp_results_rodent6 = changepoint_model(ldamodel, x, 6, weights = rep(1,length(year_continuous)))
save(cp_results_rodent6, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper6.Rds'))
rm(cp_results_rodent6)
```

```{r select paper LDA and paper cpt}
#### Changepoint model selection ####
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_1.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_2.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_3.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_4.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_5.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_6.Rds'))
...
save(ldats_ldats_cpt, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_ldats.Rds'))
rm(ldats_ldats_cpt)
rm(ldats_lda_selected)
```

```{r load LDATS LDA and LDATS changepoint, include = F}
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_ldats.Rds'))
```
...
save(ldats_ldats_cpt_selected, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_ldats_selected.Rds'))
...
save(paper_ldats_cpt, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_ldats.Rds'))
rm(paper_ldats_cpt)
rm(ldamodel)
```

```{r load paper LDA and LDATS changepoint, include = F}
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_ldats.Rds'))
```
...
save(paper_ldats_cpt_selected, file = here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_ldats_selected.Rds'))
...
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_ldats_selected.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'ldats_ldats_selected.Rds'))
load(here::here('vignette', 'christensenetal-comparison-files', 'model-cache', 'paper_paper_4.Rds'))
...
source(here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'LDA_figure_scripts.R'))
source(here::here('vignette', 'christensenetal-comparison-files', 'christensenetal-2018-files', 'changepointmodel.r'))
