#
# this was run with previous versions of the code such that it might not work
#  as is with the new functions
#    in particular: the change point model runs now include 0 change points
#
