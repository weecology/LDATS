...
```{r run adj vs non adj LDAS, eval = F}
...
ldats_ldas <- LDATS::LDA_set(document_term_table = rodents_adj$document_term_table, topics = c(2:6), nseeds = 100)
...
ntopics = 4
SEED = unlist(best_seed)[1]  # For the paper, I use seed 206
ldamodel = LDA(rodents_adj[[1]],ntopics, control = list(seed = SEED),method='VEM')
