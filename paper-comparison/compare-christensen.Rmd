...
```{r save LDAs}
save(ldamodel, file = 'paper_lda.Rds')
save(ldats_lda_selected, file = 'ldats_lda.Rds')
```
...
```{r paper changepoint on LDATS lda}
...
save.image(file = '/Users/renatadiaz/Desktop/paper_cpt_ldats_lda.Rdata') # saving it to the LDATS directory breaks git...?
...
The lowest deviance (1215.971) is for 5 changepoints!
